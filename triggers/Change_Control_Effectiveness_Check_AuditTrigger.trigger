...
trigger Change_Control_Effectiveness_Check_AuditTrigger on Change_Control_Effectiveness_Check__c (before update,before delete,after insert,after update){
