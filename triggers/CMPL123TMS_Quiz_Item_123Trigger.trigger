...
trigger CMPL123TMS_Quiz_Item_123Trigger on CMPL123TMS__Quiz_Item__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
