...
trigger CMPL123CME_Complaint_Investigation_AuditTrigger on CMPL123CME__Complaint_Investigation__c (before update,before delete,after insert,after update){
